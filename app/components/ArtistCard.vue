<template>
  ...
  >
    <div class="flex flex-col items-center pt-8 pb-4">
      ...
      <div class="w-32 h-32 rounded-full overflow-hidden mb-4 bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center">
        <img 
          v-if="artist.image" 
          :src="artist.image" 
          :alt="artist.title" 
      ...
      <div class="px-6 pb-4 text-center">
        ...
        <p v-if="artist.description" class="text-gray-600 mb-4 line-clamp-2 leading-relaxed">{{ artist.description }}</p>
        <div v-if="artist.genres && artist.genres.length" class="flex flex-wrap gap-2 justify-center">
          <span 
